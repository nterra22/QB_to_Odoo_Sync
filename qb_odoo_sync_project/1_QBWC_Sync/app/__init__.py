"""
Flask application factory for QB PostgreSQL Sync.

Creates and configures the Flask application with SOAP service integration
for QuickBooks Web Connector inventory extraction to PostgreSQL.
"""
...
def create_app():
    ...
    spyne_wsgi_app = WsgiApplication(soap_app)
      # Define the main SOAP endpoint at /quickbooks (to match .qwc file)
    ...
    def health_check():
        ...
        return {"status": "healthy", "service": "QB PostgreSQL Sync"}, 200
    ...
    def service_info():
        ...
        return {
            "service": "QuickBooks → PostgreSQL Sync Server",
            "description": "Extracts QB inventory to PostgreSQL database",
            "soap_endpoint": "/qbwc",
            "wsdl": "/qbwc?wsdl",
            "status": "running"
        }, 200
    ...
    # Log startup
    print("[INFO] Flask app created. /qbwc POST and GET endpoint registered for QBWC service.")
    print("[INFO] Service extracts QuickBooks inventory to PostgreSQL database")
